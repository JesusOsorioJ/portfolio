...
export var databases = [
        ...
        herramientas:{ all:["javascript","react","sass","redux","socket","node","sendgrid","cloudinary","stripe","mongodb","express"],
      ...
      },
      {
        ...
        herramientas:{ all:["javascript","react","sass","redux","reactrouter","firebase","fbauthentication","express"],
  ...
  herramientas:{ all:["graphql","node","express","nodemon","mongodb"],
                 front:[""],
