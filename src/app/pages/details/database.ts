...
export var databases = [
        ...
        herramientas:{ all:["javascript","react","sass","redux","socket","node","sendgrid","cloudinary","stripe","mongodb"],
                       front:["javascript","react","sass","redux","socket"],
      ...
      },
      {
        ...
        herramientas:{ all:["javascript","react","sass","redux","reactrouter","firebase","fbauthentication"],
                       front:["javascript","react","sass","redux","reactrouter"],
                       back:[""],
      ...
      herramientas:{ all:[],
                     front:["javascript","angular","tailwind","gsap","scrolltrigger"],
                     back:[""],
                     database:[""]},
    ...
    herramientas:{ all:["javascript","react","sass","redux","node","express","nodemon","mongodb"],
                   front:["javascript","react","sass","redux"],
  ...
  herramientas:{ all:["node","express","nodemon","graphql","mongodb"],
                 front:[""],
